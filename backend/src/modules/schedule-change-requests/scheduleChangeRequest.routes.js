...
const proposedDateRangeValidator = body("proposed_end_date")
  ...
  .isDate()
  .withMessage("proposed_end_date must be a valid date")
  .custom((endDate, { req }) => {
    if (
...
const createValidator = [
  ...
  body("reason_text").trim().notEmpty().withMessage("reason_text is required"),
];
...
router.post(
  ...
  idValidator,
  asyncHandler(getScheduleChangeOptions),
);
