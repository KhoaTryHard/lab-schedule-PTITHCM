...
const featureCards = [
  ...
  {
    title: "Kiểm tra số máy và thiết bị",
    description:
      "Đối chiếu sức chứa, cấu hình và tình trạng thiết bị với nhu cầu từng lớp thực hành.",
    iconName: "laptop",
  },
  {
    title: "Quản lý phòng máy và thiết bị",
    description:
  ...
  },
  {
    ...
    description:
      "Ghi nhận lỗi thiết bị và tình trạng phòng để xử lý kịp thời.",
    iconName: "alert",
  },
  {
        ...
        <section className="sectionBlock ctaSection">
          <div className="contentContainer">
            <div className="ctaCard">
              ...
              {/* Nút CTA chuyển sang trang đăng nhập của hệ thống. */}
