...
export function renderAcademicIcon(iconName, className = "", size = 24) {
  ...
  switch (iconName) {
    ...
    case "trainingData":
      return (
        <svg {...commonProps}>
          <path d="M4 7h16" />
          <path d="M6 4h12a2 2 0 0 1 2 2v13H4V6a2 2 0 0 1 2-2Z" />
          <path d="M8 11h8" />
          <path d="M8 15h5" />
        </svg>
      );
    ...
    case "academicNotification":
      return (
        <svg {...commonProps}>
          <path d="M6 16h12l-1.5-2v-3.5a4.5 4.5 0 0 0-9 0V14Z" />
    ...
    case "draft":
      return (
        <svg {...commonProps}>
          <path d="M5 19h14" />
          <path d="M7 15 17.5 4.5 20 7 9.5 17.5 6 18Z" />
        </svg>
      );
...
export function renderSidebarIcon(iconName) {
  ...
  switch (iconName) {
    ...
    case "academicNotification":
    case "academicReport":
      return renderAcademicIcon(iconName);
    case "lecturerOverview":
      return (
        <svg {...commonProps}>
    ...
    case "lecturerSchedule":
      return (
        <svg {...commonProps}>
          ...
          <path d="M8 14h4" />
          <path d="M8 17h7" />
          <path d="M16.5 14.5 18 16l2.5-3" />
        </svg>
      );
    case "lecturerChangeRequest":
      return (
        <svg {...commonProps}>
          <path d="M7 4h8l4 4v12H7z" />
          <path d="M15 4v4h4" />
          ...
          <path d="m16.5 16.5 2 2 3-3.5" />
        </svg>
      );
    case "lecturerIssueReport":
      return (
        <svg {...commonProps}>
    ...
    case "technicianOverview":
      return (
        <svg {...commonProps}>
          ...
          <path d="M8 9h3" />
          <path d="M8 12h2" />
          <path d="m15 10 1.5-1.5 2 2L17 12" />
          <path d="m16.5 11.5 2.5 2.5" />
        </svg>
      );
    case "technicianRoomSchedule":
      return (
        <svg {...commonProps}>
          <rect x="4" y="5" width="16" height="15" rx="2.5" />
          <path d="M8 3v4" />
          ...
          <path d="M8 17h3" />
          <path d="M15 14h2.5" />
          <path d="M16.25 12.75v2.5" />
        </svg>
      );
    case "technicianRoomStatus":
      return (
        <svg {...commonProps}>
          <rect x="4" y="5" width="16" height="11" rx="2" />
          <path d="M8 20h8" />
          <path d="M12 16v4" />
          <path d="M8 11.5a4 4 0 0 1 8 0" />
          <path d="m12 11.5 2.5-2.5" />
          <path d="M9 13.5h6" />
        </svg>
      );
    case "technicianIssueReport":
      return (
        <svg {...commonProps}>
          <path d="M12 3 3.5 19h17L12 3Z" />
          <path d="M12 8v5" />
          <path d="M12 16h.01" />
          <path d="m16 6 1.5-1.5 2 2L18 8" />
          <path d="m17.5 7.5 2.5 2.5" />
        </svg>
      );
    case "technicianNotification":
      return (
        <svg {...commonProps}>
          <path d="M18 9a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9" />
          <path d="M10 21h4" />
          <path d="m16.5 4.5 1.5-1.5 2 2-1.5 1.5" />
          <path d="m18.5 6.5 2 2" />
        </svg>
      );
    case "studentOverview":
      return (
        <svg {...commonProps}>
          ...
          <rect x="13.5" y="4" width="6.5" height="6.5" rx="1.6" />
          <rect x="4" y="13.5" width="6.5" height="6.5" rx="1.6" />
          <path d="m13.5 16 3.25-1.75L20 16l-3.25 1.75L13.5 16Z" />
          <path d="M14.75 17v1.5c0 .8.9 1.5 2 1.5s2-.7 2-1.5V17" />
        </svg>
      );
    case "studentSchedule":
      return (
        <svg {...commonProps}>
          ...
          <path d="M8 14h4" />
          <path d="M8 17h3" />
          <path d="m15 15 2-1 2 1-2 1-2-1Z" />
        </svg>
      );
    ...
    case "studentFeedback":
      return (
        <svg {...commonProps}>
          ...
          <path d="M8 10h5" />
          <path d="M8 13h4" />
          <path d="m15.5 12.5 3-3 2 2-3 3H15v-2Z" />
        </svg>
      );
    case "dashboard":
      return (
    ...
    case "account":
      return (
        <svg {...commonProps}>
          ...
          <path d="M3.75 19c.45-3 2.75-4.75 5.25-4.75S13.8 16 14.25 19" />
          <path d="M16.5 7.5h4" />
          <path d="M18.5 5.5v4" />
          <path d="M16.5 14h4" />
          <path d="M16.5 18h4" />
    ...
    case "training":
      return (
        <svg {...commonProps}>
          <path d="m3.5 8.5 8.5-4.5 8.5 4.5-8.5 4.5-8.5-4.5Z" />
          <path d="M7 11v4c0 1.6 2.25 3 5 3s5-1.4 5-3v-4" />
          <path d="M20.5 9v5" />
        </svg>
      );
    case "schedule":
    ...
    case "audit":
      return (
        <svg {...commonProps}>
          <path d="M7 4h10l2 2v16H5V6l2-2Z" />
          <path d="M9 9h6" />
          <path d="M9 13h6" />
          <path d="M9 17h3" />
          <path d="m15 17 1.25 1.25L19 15.5" />
        </svg>
      );
    default:
      return null;
