...
export function updateRoomBlockRequest(blockId, payload) {
  return apiClient(`/room-block-requests/${blockId}`, {
    method: "PATCH",
    body: JSON.stringify(payload),
  });
}

export function submitRoomBlockRequest(blockId, payload = {}) {
  return apiClient(`/room-block-requests/${blockId}/submit`, {
    method: "PATCH",
    body: JSON.stringify(payload),
  });
}

export function cancelRoomBlockRequest(blockId, payload = {}) {
  return apiClient(`/room-block-requests/${blockId}/cancel`, {
    method: "PATCH",
    body: JSON.stringify(payload),
  });
}
...
export function applyRoomBlockStatus(blockId, payload) {
  return apiClient(`/room-block-requests/${blockId}/apply-room-status`, {
    method: "PATCH",
    body: JSON.stringify(payload),
  });
}
