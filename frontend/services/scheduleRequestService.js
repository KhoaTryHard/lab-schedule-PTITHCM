...
export function updateScheduleRequest(requestId, payload) {
  return apiClient(`/schedule-requests/${requestId}`, {
    method: "PATCH",
    body: JSON.stringify(payload),
  });
...
export function approveScheduleRequest(requestId) {
  return apiClient(`/schedule-requests/${requestId}/approve`, {
    method: "PATCH",
  });
}

export function cancelScheduleRequest(requestId) {
  return apiClient(`/schedule-requests/${requestId}/cancel`, {
    method: "PATCH",
  });
}

export function publishScheduleRequest(requestId) {
  return apiClient(`/schedule-requests/${requestId}/publish`, {
    method: "PATCH",
  });
}
