...
export const ROLE_LAYOUT_CONFIG = {
  QTV: {
    ...
    navItems: [
      ...
      { icon: "equipment", itemName: "Phòng máy & thiết bị", href: "/admin/rooms" },
      { icon: "school", itemName: "Dữ liệu đào tạo", href: "/admin/trainingData" },
      { icon: "search", itemName: "Tra cứu toàn hệ thống", href: "/admin/lookups" },
  ...
  CBDT: {
    ...
    navItems: [
      ...
      { icon: "person", itemName: "Yêu cầu xếp lịch", href: "/academic/schedule-requests" },
      { icon: "chart", itemName: "Xếp lịch tự động", href: "/academic/auto-arrange" },
      { icon: "school", itemName: "Lịch thực hành", href: "/academic/schedules" },
      { icon: "search", itemName: "Yêu cầu đổi/hủy/bù", href: "/academic/change-requests" },
      { icon: "settings", itemName: "Thông báo", href: "/academic/notifications" },
  ...
  GV: {
    ...
    navItems: [
      ...
      { icon: "chart", itemName: "Đổi / bù / hủy lịch", href: "/lecturer/change-requests" },
      { icon: "equipment", itemName: "Báo cáo sự cố", href: "/lecturer/room-issues" },
      { icon: "settings", itemName: "Thông báo", href: "/lecturer/notifications" },
    ],
  },
  KTV: {
    roleCode: "KTV",
    ...
    navItems: [
      ...
      { icon: "equipment", itemName: "Lịch sử dụng phòng", href: "/technician/room-schedule" },
      { icon: "settings", itemName: "Tình trạng phòng", href: "/technician/room-status" },
      { icon: "person", itemName: "Sự cố phòng máy", href: "/technician/issues" },
      { icon: "search", itemName: "Thông báo", href: "/technician/notifications" },
    ],
  },
  SV: {
    roleCode: "SV",
    ...
    navItems: [
      ...
      { icon: "school", itemName: "Lịch sinh viên", href: "/student/my-schedule" },
      { icon: "settings", itemName: "Thông báo", href: "/student/notifications" },
